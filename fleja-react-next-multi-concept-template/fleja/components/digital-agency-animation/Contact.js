            ...
            <section className="contact-cta-area ptb-120">
                <div className="container">
                    <div className="contact-cta-content">
                        ...
                        <p>
                            UTCG works has worked with countless graphics and software companies to bring workshops, job
                            fairs, research talks, and much more to the students of U of T, as well as those outside.
                        </p>
