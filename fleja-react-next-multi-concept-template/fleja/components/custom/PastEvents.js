                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.eventbrite.ca/e/utcg-shaders-workshop-tickets-474947228947">Minecraft Shaders Workshop</a></h3>
								<a href="https://www.eventbrite.ca/e/utcg-shaders-workshop-tickets-474947228947" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
							</div>
						</div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.eventbrite.ca/e/utcg-shaders-workshop-tickets-474947228947">Bunny Social</a></h3>
								<a href="https://www.eventbrite.ca/e/utcg-shaders-workshop-tickets-474947228947" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
							</div>
						</div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.facebook.com/events/875874843302115/">Halo: A VFX Breakdown</a></h3>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.facebook.com/events/875874843302115/">Siggraph Viewing Social</a></h3>
								<a href="https://www.facebook.com/events/875874843302115/" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
							</div>
						</div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.facebook.com/events/875874843302115/">Model UofT</a></h3>
								<a href="https://www.facebook.com/events/875874843302115/" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
							</div>
						</div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
						<div className="single-blog-post">
							...
							<div className="blog-post-content">
								...
								<h3><a href="https://www.facebook.com/events/875874843302115/">Blender Workshop: Fundamentals of 3D Graphics</a></h3>
								<a href="https://www.facebook.com/events/875874843302115/" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
							</div>
						</div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
                        <div className="single-blog-post">
                            ...
                            <div className="blog-post-content">
                                ...
                                <h3><a href="#">Rapid Fire Research Talks</a></h3>
                    ...
                    <div className="col-lg-4 col-md-6 grid-items">
                        <div className="single-blog-post">
                            ...
                            <div className="blog-post-content">
                                ...
                                <h3><a href="#">The Mandalorian: A VFX Breakdown</a></h3>
                                <a href="#" className="read-more-btn">Read More <i className="icofont-double-right"></i></a>
                            </div>
                        </div>
                    </div>
