          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-team">
                <div className="team-image">
                  <img
                    src="/images/team-image/2021-team-images/rikin.png"
                  ...
                  <ul className="social-links">
                    <li>
                      <a href="https://rikingurditta.github.io">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-team">
                <div className="team-image">
                  <img
                    src={"/images/team-image/2021-team-images/doris.jpg"}
                    className="member-img"
                    alt="team"
                  />
                  <img
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
              <div className="single-team">
                <div className="team-image">
                  <img
                    src={"/images/team-image/2021-team-images/kurtis.jpg"}
                    className="member-img"
                    alt="team"
                  />
                  <img
                  ...
                  <ul className="social-links">
                    <li>
                      <a href="https://www.linkedin.com/in/kurtislaw">
                        <i className="icofont-linkedin"></i>
                      </a>
                    </li>
                    <li>
                      <a href="https://github.com/kurtislaw">
                        <i className="icofont-github"></i>
                      </a>
                    </li>
                  </ul>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
              <div className="single-team">
                <div className="team-image">
                  <img
                    src="/images/team-image/2021-team-images/edith.jpg"
                    className="member-img"
                    alt="team"
                  />
                  <img
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 offset-lg-0 offset-md-3 offset-sm-3">
              <div className="single-team">
                <div className="team-image">
                  <img
                    src="/images/team-image/2021-team-images/luwai.png"
                    className="member-img"
                    alt="team"
                  />
                  <img
                ...
                <div className="team-content">
                  <h3>Lu-Wai Wong</h3>
                  <span>Marketing Executive Member</span>
                </div>
              </div>
            </div>
          </div>
